...
#$ -m e
#$ -t 1-12
#$ -j y -o output_analysis/qsub_logs/eval_top_$TASK_ID.out
...
inputs_file="$PROJ_DIR/output_analysis/test_set_splits_files/$lang_pair/source_top_500_sents.txt"
references_file="$PROJ_DIR/output_analysis/test_set_splits_files/$lang_pair/target_top_500_sents.txt"
...
predictions_file="$PROJ_DIR/output_analysis/model_output_files/$lang_pair/$MODEL_NAME/top_500_sents.txt"

record_file="$PROJ_DIR/output_analysis/results_60k_split_test_sets_high_density.json"
...
--from_file \
--EXP_ID "high_density_$MODEL_NAME" \
--save_results \
