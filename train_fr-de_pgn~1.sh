...
#$ -m e
#$ -t 1-4
#$ -j y -o qsub_logs/van-frde_$TASK_ID.out
...
EXP_ID="vanilla"
MODEL_NAME="$EXP_ID-fr~de-wm-epochs~$epochs-max_lines~$max_lines-vocab_size~$vocab_size"
TOKENIZER_NAME="$EXP_ID-fr~de-wm-max_lines~$max_lines-vocab_size~$vocab_size"
...
python vanilla.py \
--DATADIR_L1 /export/b08/nbafna1/data/wikimatrix/fr-de/splits/fr/ \
--DATADIR_L2 /export/b08/nbafna1/data/wikimatrix/fr-de/splits/de/ \
